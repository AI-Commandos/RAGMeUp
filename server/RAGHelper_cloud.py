...
class RAGHelperCloud(RAGHelper):
    def __init__(self, logger):
        ...
        self.max_length = int(os.getenv("max_document_limit", 10))  # Default to 10 if not specified
    ...
    def graph_retriever(self, user_query):
        ...
        retrieval_question = os.getenv('rag_retrieval_question').replace("{question}", user_query)
